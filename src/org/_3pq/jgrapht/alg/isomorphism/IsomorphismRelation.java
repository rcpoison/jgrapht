...
import org._3pq.jgrapht.GraphMapping;
import org._3pq.jgrapht.graph.DefaultGraphMapping;
import org._3pq.jgrapht.util.ArrayUtil;


/** Holds a isomorphism relation for two graphs.
 * It contains a mapping between the two graphs. 
 * <p>Usage:
 * <ol>
 * <li>use <code>getCorrespondence()</code> to get the mapped object in the other 
 * graph.
 * <li>use <code>getGraph1vertexArray(), getGraph2vertexArray()</code> to see the full vertex
 * arrays order , in which the i-th vertex in the 1st array is the isomorphic eqv. 
 * of the i-th in 2nd array.
 * </ol> 
 * <p>
 * <p>It consists of two vertexes array , the i-th vertex 
 * in the 1st array is the isomorphic eqv. of the i-th in 2nd array. 
 * Note that the getters are unsafe (they return the array and not
 * a copy of it)
 * 
 *	@author Assaf
 *	@since	May 27, 2005
...
public class IsomorphismRelation implements GraphMapping
{
	 ...
	 * 
	 */
	public IsomorphismRelation(Object[] aGraph1vertexArray,Object[] aGraph2vertexArray,Graph g1,Graph g2 ) {
	...
	public String toString()
	{
		...
		sb.append("graph1vertexArray: ").append(ArrayUtil.toString(this.graph1vertexArray));
		sb.append("\tgraph2vertexArray: ").append(ArrayUtil.toString(this.graph2vertexArray));
		return sb.toString();
	...
	{
		//lazy initiliazr graphMapping 
		if (graphMapping==null)
		{
			initGraphMapping();
		}
		
		Object resultObject =	 this.graphMapping.getCorrespondence(vertexOrEdge,forward);
		return resultObject;
	}
	
	/** we currently have the vertexes array. From them we will construct
	 * two maps: g1ToG2 and g2ToG1 , using the array elements with the same index.
	 */
