 ...
 * @since Jul 19, 2003
 */
public class DeepFirstIterator extends AbstractGraphIterator {
	 ...
	 */
	public DeepFirstIterator(DirectedGraph g, Object startVertex) {
		super();
		init(g, startVertex);
	 ...
	 * @param startVertex the vertex iteration to be started.
	 */
	public DeepFirstIterator(UndirectedGraph g, Object startVertex) {
		super();
		init(g, startVertex);
