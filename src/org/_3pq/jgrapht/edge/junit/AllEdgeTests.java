...
public class AllEdgeTests {
    ...
    public static Test suite(  ) {
        ...
        suite.addTest( new TestSuite( DefaultDirectedWeightedEdgeTest.class ) );
        suite.addTest( new TestSuite( DefaultUndirectedEdgeTest.class ) );
        suite.addTest( new TestSuite( DefaultUndirectedWeightedEdgeTest.class ) );
