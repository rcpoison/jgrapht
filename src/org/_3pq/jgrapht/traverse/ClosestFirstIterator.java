 ...
 * @since Sep 2, 2003
 */
public class ClosestFirstIterator<V, E extends Edge<V>> extends CrossComponentIterator<V, E, ClosestFirstIterator.QueueEntry> {
    ...
    static class QueueEntry<V,
            E extends Edge<V>> extends FibonacciHeap.Node {
