 ...
 * <code>UnsupportedOperationException</code>, but vertex addition/removal
 * and edge removal are all supported (and immediately reflected in the backing
 * graph).
 *
 ...
 * @since Aug 14, 2003
 */
public class AsUndirectedGraph extends GraphDelegator
    ...
    public String toString(  ) {
        ...
        while ( iter.hasNext(  ) ) {
            ...
            edgeSet.add(
                new UndirectedEdge( edge.getSource(  ), edge.getTarget(  ) ) );
        }
        
        return super.toStringFromSets( vertexSet(  ), edgeSet );
    }
    
    // the methods below suppress the default GraphDelegator behavior
