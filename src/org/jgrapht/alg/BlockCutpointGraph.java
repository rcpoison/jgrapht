 ...
 * href="http://www.albany.edu/~goel/publications/rosencrantz2005.pdf">Structure-Based
...
public class BlockCutpointGraph<V,E> extends SimpleGraph<UndirectedGraph<V,E>,DefaultEdge> {
    ...
    public BlockCutpointGraph(UndirectedGraph<V,E> graph) {
        ...
        for (Iterator<V> iter = this.cutpoints.iterator(); iter.hasNext();) {
            ...
            UndirectedGraph<V,E> subgraph = new SimpleGraph<V,E>(this.graph
                    .getEdgeFactory());
            ...
            for (Iterator<UndirectedGraph<V,E>> iterator = biconnectedSubgraphs.iterator(); iterator
                    .hasNext();) {
                UndirectedGraph<V,E> biconnectedSubgraph = iterator
                        .next();
    ...
    /**
     * Renvoie <code>true</code> if the vertex is a cutpoint,
