 ...
 * href="http://en.wikipedia.org/wiki/Kruskal's_algorithm">Kruskal's
 * minimum spanning tree algorithm</a>. If the given graph is connected
 * it computes the minimum spanning tree, otherwise it computes the minimum
 * spanning forest. The algorithm runs in time O(E log E). This implementation
 * uses the hashCode and equals method of the vertices.
 *
 * @author Tom Conerly
 * @since Feb 10, 2010
 */
public class KruskalMinimumSpanningTree<V,E>
{
    ...
    /**
     * Creates and executes a new KruskalMinimumSpanningTree algorithm instance. An
     * instance is only good for a single spanning tree; after construction, it can be
     * accessed to retrieve information about the spanning tree found.
     *
