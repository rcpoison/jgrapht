 ...
 * <a href="http://www.infosun.fmi.uni-passau.de/Graphlet/GML/">http://www.infosun.fmi.uni-passau.de/Graphlet/GML/</a>.</p>
 * 
 * <p>The objects associated with vertices and edges are exported as labels using 
 * their toString() implementation. See
 * the {@link #setPrintLabels(Integer)} method. The default behavior is to export
 * no label information.</p>
 *
...
public class GmlExporter<V, E>
{
    ...
    private void exportVertices( PrintWriter out, VertexNameProvider<V> nameProvider, Graph<V,E> g )
    {
    ...
    private void exportEdges( PrintWriter out, VertexNameProvider<V> nameProvider, Graph<V,E> g )
    {
    ...
    /** Exports an undirected graph into a plain text file in GML 
     *  format. 
     *
    ...
    /** Exports a directed graph into a plain text file in GML 
     *  format. 
     *
     *  @param output the writer to which the graph to be exported
    ...
    /** Set whether to export the vertex and edge labels. The default behavior
     *  is to export no vertex or edge labels.
     ...
     *  @return One of the {@link #PRINT_NO_LABELS}, 
     *           {@link #PRINT_EDGE_LABELS}, {@link #PRINT_EDGE_VERTEX_LABELS}, or
     *           {@link #PRINT_VERTEX_LABELS}.
     */
