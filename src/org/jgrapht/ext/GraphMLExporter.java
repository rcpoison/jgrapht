 ...
 * <a href="http://en.wikipedia.org/wiki/GraphML">http://en.wikipedia.org/wiki/GraphML</a>.</p>
 * 
...
public class GraphMLExporter<V, E>
{
     ...
     *  the vertex and edge IDs and null providers for the vertex and edge labels.
     */
