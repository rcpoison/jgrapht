 ...
 * <a href = "http://mathworld.wolfram.com/Scale-FreeNetwork.html">scale-free network</a> of any size.
 * Scale-free network is a connected graph, where degrees of vertices are distributed in
 * unusual way. There are many vertices with small degrees and only small amount
 * of vertices with big degrees.
 * 
...
public class ScaleFreeGraphGenerator<V, E>
    ...
    /**
     * Constructs a new <code>ScaleFreeGraphGenerator</code> using fixed
     * <code>seed</code> for the random generator.
     * 
     * @param size number of vertices to be generated
     ...
     * Each call of this method produces identical output
     * (but if <code>target</code> is an undirected graph, the directions of edges will be lost).
     * 
