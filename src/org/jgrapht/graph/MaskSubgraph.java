 ...
 * subgraph will keep track of edges being added to its vertex subset as well
 * as deletion of edges and vertices. When iterating over the vertices/edges,
 * it will iterate over the vertices/edges of the base graph and discard
...
public class MaskSubgraph<V, E> extends AbstractGraph<V, E> {
    ...
    public Set<E> getAllEdges(V sourceVertex, V targetVertex) {
        ...
        if (containsVertex(sourceVertex) && containsVertex(targetVertex)) {
            return new MaskEdgeSet<V,E>(this.base, this.base.getAllEdges(
                    sourceVertex, targetVertex), this.mask);
        }
    ...
    public Set<E> incomingEdgesOf(V vertex) {
        ...
        return new MaskEdgeSet<V,E>(this.base, ((DirectedGraph<V,E>) this.base)
                .incomingEdgesOf(vertex), this.mask);
    }
    ...
    public Set<E> outgoingEdgesOf(V vertex) {
        ...
        return new MaskEdgeSet<V,E>(this.base, ((DirectedGraph<V,E>) this.base)
                .outgoingEdgesOf(vertex), this.mask);
    }
