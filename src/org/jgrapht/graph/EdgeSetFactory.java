...
public interface EdgeSetFactory<V, E>
{
     ...
     *               sophisticated factories may be able to use this information
     *               to choose an optimal set representation (e.g.
     *               ArrayUnenforcedSet for a vertex expected to have low
     *               degree, and LinkedHashSet for a vertex expected to have
     *               high degree)
     *
     * @return new set
     */
