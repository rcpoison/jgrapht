 ...
 * choose the {@link java.util.Set} implementation used internally by the
 * graph to maintain sets of edges.  This provides control over performance
...
public interface EdgeSetFactory<V, E>
{
     ...
     * optimal set representation (e.g.  ArrayUnenforcedSet for a vertex
     * expected to have low degree, and LinkedHashSet for a vertex expected to
     * have high degree)
     *
     * @return new set
     */
