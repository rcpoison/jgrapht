	...
	extends TestCase
{
	...
	{
		DirectedWeightedMultigraph<Integer, DefaultWeightedEdge> simple = new DirectedWeightedMultigraph<Integer, DefaultWeightedEdge>(DefaultWeightedEdge.class);
		simple.addVertex(0);
		simple.addVertex(1);
		...
		try
		{
			new EdmondsKarpMaximumFlow<Integer, DefaultWeightedEdge>(simple, -0.1);
			fail();
		}
		...
		{
			simple.setEdgeWeight(e, 1.0);
			EdmondsKarpMaximumFlow<Integer, DefaultWeightedEdge> solver = new EdmondsKarpMaximumFlow<Integer, DefaultWeightedEdge>(simple);
	...
	{		
		...
		for (int i = 0; i < q; i++)
		{
			...
			for (Integer v: network.vertexSet())
			{
				...
				{
					assertEquals(-flowValue, balance, EdmondsKarpMaximumFlow.DEFAULT_EPSILON);
				}
				...
				{
					assertEquals(0.0, balance, EdmondsKarpMaximumFlow.DEFAULT_EPSILON);
				}
			}
		}
	}
